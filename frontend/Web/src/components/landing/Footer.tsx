        ...
        <footer className="bg-secondary pt-12 sm:pt-16 pb-8 text-white relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            <a className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e8cdba] text-secondary hover:bg-primary hover:text-white transition-colors" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
                                <span className="text-xs font-bold">f</span>
                            </a>
                            <a className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e8cdba] text-secondary hover:bg-primary hover:text-white transition-colors" href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer">
                            ...
                            <a className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e8cdba] text-secondary hover:bg-primary hover:text-white transition-colors" href="https://www.twitter.com/" target="_blank" rel="noopener noreferrer">
                                <span className="text-xs font-bold">x</span>
                            </a>
                            <a className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e8cdba] text-secondary hover:bg-primary hover:text-white transition-colors" href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 mb-6">
                            <input 
                                className="flex-1 rounded bg-white px-3 py-2 text-sm text-secondary focus:outline-none focus:ring-2 focus:ring-primary" 
                            ...
                            <button 
                                ...
                                className="bg-primary px-4 py-2 text-sm font-bold text-white rounded hover:bg-orange-600 transition-colors flex items-center justify-center gap-1 whitespace-nowrap"
                            >
                ...
                <div className="border-t border-slate-800 pt-8 text-center">
                    <p className="text-[10px] text-slate-400">Copyright © {new Date().getFullYear()} Edunura. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
