...
export default function CalendarPage() {
    ...
    return (
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100%', bgcolor: theme.palette.background.paper, p: { xs: 2, md: 3 } }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                    ...
                    >
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, width: '100%' }}>
                            ...
                            <Box sx={{ flex: 1, minWidth: 0 }}>
                                ...
                                <Typography sx={{ fontWeight: 700, color: theme.palette.text.primary, mt: 0.25 }}>
                                    {nextSession.title}
                                </Typography>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, width: { xs: '100%', sm: 'auto' } }}>
                            <Button
                                ...
                                onClick={() => router.push(nextSession.lesson ? `/course/${nextSession.course_id}/lesson/${nextSession.lesson.id}` : `/course/${nextSession.course_id}/learn`)}
                                sx={{
                                    bgcolor: theme.palette.primary.main,
                                    borderRadius: '12px',
                                    fontWeight: 700,
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', px: 1, flexDirection: { xs: 'column', md: 'row' }, gap: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                        <Typography sx={{ fontSize: '12px', color: theme.palette.text.secondary, whiteSpace: 'nowrap' }}>
                            Showing{' '}
                            <Typography component="span" sx={{ fontSize: '12px', fontWeight: 700, color: theme.palette.text.primary }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                            ...
                            <Button
                                ...
                                size="small"
                                sx={{ minWidth: 28, p: 0.5, color: theme.palette.text.secondary }}
                            >
                ...
                >
                    ...
                    >
                        {calendarData.prevMonthDays.map((day: number, idx: number) => (
                            ...
                            >
                                <Typography sx={{ fontSize: '12px', fontWeight: 700, color: theme.palette.text.disabled }}>
                                    {day}
                                </Typography>
                            </Box>
                        ))}
