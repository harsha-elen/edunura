...
const TeacherAssignments: React.FC = () => {
    ...
    const loadCourses = async () => {
        try {
            ...
            let allCourses = response.data && response.data.courses ? response.data.courses : (Array.isArray(response) ? response : (response.data || []));
            ...
            const teacherCourses = getTeacherAssignedCourses(allCourses, user.id);
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            <Box>
                ...
                >
                    <MuiLink component={Link} underline="hover" color="inherit" href="/teacher">
                        Home
                    </MuiLink>
                            ...
                            <Grid size={{ xs: 12, sm: 6, lg: 4, xl: 3 }} key={course.id}>
                                ...
                                >
                                    ...
                                    <Box sx={{ p: 2.5, display: 'flex', flexDirection: 'column', flex: 1 }}>
                                        ...
                                        <Button
                                            component={Link}
                                            href={`/teacher/assignments/${course.id}`}
                                            variant="contained"
                                            fullWidth
                                            sx={{
