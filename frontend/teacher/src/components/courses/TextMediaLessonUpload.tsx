...
const TextMediaLessonUpload: React.FC<TextMediaLessonUploadProps> = ({ open, onClose, onBack, onSave, initialData }) => {
    ...
    const [allowPreview] = useState(initialData?.allowPreview || false); // Fixed to false/initial but UI removed
    ...
    const handleSubmit = async () => {
        ...
        // Logic for closing is handled by CurriculumSection processing or modal wrapping
    };
