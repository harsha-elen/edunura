...
const AdminLayoutComponent: React.FC<AdminLayoutComponentProps> = ({ children }) => {
    const router = useRouter();
    const pathname = usePathname();
    const theme = useTheme();
    const [mobileOpen, setMobileOpen] = useState(false);
    const [anchorEl, setAnchorEl] = useState<null | HTMLElement>(null);
    const [siteName, setSiteName] = useState(typeof window !== 'undefined' ? localStorage.getItem('site_name') || 'EduPro LMS' : 'EduPro LMS');
    ...
    const allMenuItems = [
        ...
        {
            text: 'Students',
            icon: <Box component="img" src="/images/student.ico" alt="Students" sx={{ width: 22, height: 22 }} />,
            path: '/admin/students',
        },
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            ...
                            <Menu
                                ...
                                onClose={handleClose}
                            >
                                <MenuItem onClick={() => { handleClose(); router.push('/admin/profile'); }}>Profile</MenuItem>
