...
const Teachers: React.FC = () => {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            await deleteTeacher(id, 'permanent');
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <Button
                    ...
                    sx={{
                        ...
                        fontWeight: 600,
                        px: 3,
                        '&:hover': { bgcolor: theme.palette.primary.dark || '#1e40af' },
                    }}
                >
                    Add Teacher
                </Button>
                                        ...
                                        >
                                            <TableCell sx={{ fontWeight: 500, color: '#0d141b', borderColor: '#e7edf3', py: 2 }}>
                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                    <Avatar sx={{ bgcolor: theme.palette.primary.main, color: 'white', fontWeight: 700, width: 40, height: 40 }}>
                                            ...
                                            <TableCell sx={{ borderColor: '#e7edf3' }} align="center">
                                                <Chip label={teacher.is_active ? 'Active' : 'Inactive'} size="small" sx={{ bgcolor: teacher.is_active ? '#f0fdf4' : '#fee2e2', color: teacher.is_active ? '#16a34a' : '#dc2626', fontWeight: 600 }} />
                                            </TableCell>
                                            <TableCell sx={{ color: '#4c739a', borderColor: '#e7edf3' }} align="center">
                                            ...
                                            <TableCell sx={{ borderColor: '#e7edf3' }} align="center">
                                                <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1 }}>
                                                    <IconButton size="small" onClick={() => handleOpenDialog(teacher)} sx={{ color: theme.palette.primary.main, '&:hover': { bgcolor: alpha(theme.palette.primary.main, 0.1) } }}>
                                                        <EditIcon sx={{ fontSize: 18 }} />
                                                    </IconButton>
                                                    <IconButton size="small" onClick={() => handleDelete(teacher.id)} sx={{ color: '#dc2626', '&:hover': { bgcolor: '#fee2e2' } }}>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
                ...
                <DialogContent sx={{ pt: 3 }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                        ...
                        <TextField label="Email Address" fullWidth required type="email" placeholder="teacher@example.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} error={!!formErrors.email} helperText={formErrors.email} size="small" />
                        <TextField
