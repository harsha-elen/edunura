...
const EditCourseCategory: React.FC = () => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            setCategories(response.data.filter((cat: CourseCategory) => cat.id !== Number(id)));
        } catch (error) {
    ...
    const fetchCategory = async () => {
        try {
            ...
            setFormData({
                ...
                icon: category.icon || 'analytics',
                color: category.color || '#2b8cee',
                accent_color: category.accent_color || '#e8f2fe',
        ...
        <Box>
            <Box sx={{ mb: 4 }}>
                ...
                >
                    ...
                    <MuiLink component={Link} underline="hover" color="inherit" href="/admin/courses/categories">
                        Categories
                    </MuiLink>
                            ...
                            <Box sx={{ display: 'flex', gap: 2 }}>
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        boxShadow: '0 12px 24px -12px rgba(43, 140, 238, 0.5)',
                                        minWidth: 150,
                                    }}
                                >
                            ...
                            <Paper elevation={0} sx={{ borderRadius: 3, p: 3, bgcolor: '#ffffff' }}>
                                ...
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, color: '#64748b', fontSize: '0.875rem' }}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                        ...
                                        {currentCategory?.course_count || 0} Courses
                                    </Box>
                            ...
                            <Box sx={{ display: 'flex', gap: 1.5 }}>
                                ...
                                <Box>
                                    ...
                                    <Box component="ul" sx={{ pl: 2, mt: 1, mb: 0, color: '#475569', fontSize: '0.875rem' }}>
                                        ...
                                        <li>Color-coding helps categorize different course types.</li>
                                    </Box>
                                </Box>
                            </Box>
                        </Paper>
