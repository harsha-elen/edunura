...
import { updateSetting, sendTestEmail, getSettings, getZoomAccount } from '@/services/settings';
        ...
        <Box sx={{ pb: 10, width: '100%' }}>
            <Box sx={{ mb: 4 }}>
                ...
                >
                    ...
                    <MuiLink component={Link} underline="hover" color="inherit" href="/admin">Admin</MuiLink>
                                    ...
                                    <Box sx={{ p: 3, display: 'flex', flexDirection: 'column', gap: 3 }}>
                                        ...
                                        <Box>
                                            ...
                                            <Box sx={{ p: 2, bgcolor: '#f8fafc', borderRadius: 2, border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', gap: 2 }}>
                                                ...
                                                <MuiLink href="#" underline="hover" sx={{ fontSize: '0.875rem', fontWeight: 500, color: selectedColor }}>Link style</MuiLink>
                                            </Box>
                                        </Box>
                                    </Box>
                                </Paper>
                                ...
                                <Paper sx={{ borderRadius: 3, border: `1px solid ${alpha(primaryColor, 0.2)}`, bgcolor: alpha(primaryColor, 0.05), p: 3 }}>
                                    <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
                                        ...
                                        <Box>
                                            ...
                                            <MuiLink href="#" underline="hover" sx={{ fontSize: '0.75rem', fontWeight: 600, mt: 1, display: 'block' }}>View Documentation →</MuiLink>
                                        </Box>
                                    </Box>
                                </Paper>
                            </Box>
