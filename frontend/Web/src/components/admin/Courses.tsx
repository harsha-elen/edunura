...
const Courses: React.FC = () => {
    ...
    const loadCourses = async () => {
        try {
            ...
            if (response.data && response.data.courses) {
                ...
                setPagination({ total: coursesList.length, totalPages: 1 });
            }
        } catch (err: any) {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            setSnackbar({
                open: true,
                message: err.response?.data?.message || err.message || 'Failed to delete course',
                severity: 'error',
            });
        } finally {
            setDeleting(false);
            ...
            >
                ...
                <DialogContent sx={{ pt: 2 }}>
                    ...
                    <Typography sx={{ color: '#dc2626', fontSize: '0.875rem' }}>
                        This action will permanently delete the course and all related content (sections, lessons, files, and folders). This cannot be undone.
                    </Typography>
                </DialogContent>
