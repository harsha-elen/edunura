...
export default function StudentLayoutComponent({ children }: StudentLayoutComponentProps) {
    ...
    const menuItems = [
        { text: 'Dashboard', icon: <DashboardIcon sx={{ fontSize: 22 }} />, path: '/student' },
        { text: 'My Courses', icon: <BookIcon sx={{ fontSize: 22 }} />, path: '/student/courses' },
        { text: 'Calendar', icon: <CalendarIcon sx={{ fontSize: 22 }} />, path: '/student/calendar' },
        { text: 'Live Classes', icon: <LiveIcon sx={{ fontSize: 22 }} />, path: '/student/live-classes' },
        { text: 'Account', icon: <AccountIcon sx={{ fontSize: 22 }} />, path: '/student/profile', divider: true },
        { text: 'Help & Support', icon: <HelpIcon sx={{ fontSize: 22 }} />, path: '/student/help' },
    ];
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            ...
                            <Menu
                                ...
                                onClose={handleClose}
                            >
                                <MenuItem onClick={() => { handleClose(); router.push('/student/profile'); }}>Profile</MenuItem>
                                <MenuItem onClick={() => { handleClose(); router.push('/student/courses'); }}>My Courses</MenuItem>
                                <MenuItem onClick={() => { handleClose(); router.push('/student/profile'); }}>Account</MenuItem>
                                <Divider />
