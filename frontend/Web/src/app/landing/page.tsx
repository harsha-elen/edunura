...
export default function Home() {
  return (
    <>
      ...
      <section className="bg-white px-4 py-12 sm:py-16 lg:py-20 my-12 relative overflow-hidden">
        <div className="mx-auto max-w-[1300px] w-full">
          <div className="bg-secondary rounded-[2.5rem] p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10">
            <div className="flex-1 text-white">
              ...
              <h2 className="font-[family-name:var(--font-quicksand)] font-bold text-3xl sm:text-4xl lg:text-[42px] leading-tight text-white">
                Are you ready to guide students from Roots to Radiance?
              </h2>
              <p className="mt-4 text-slate-200 text-sm sm:text-base">
                Join our community of educators and make a meaningful impact in students' lives.
              </p>
            </div>
            <div className="hidden lg:flex items-center justify-center flex-shrink-0">
              <img alt="Edunura Symbol" className="h-32 lg:h-40 w-auto object-contain" src="/images/edunura-symbool-scaled-1.png" />
            </div>
            <button className="bg-[#FD9A7C] hover:bg-[#E94F13] text-white px-8 lg:px-10 py-4 lg:py-5 rounded-full font-bold transition-all shadow-xl whitespace-nowrap flex-shrink-0">
              Join the Journey
            </button>
          </div>
        </div>
