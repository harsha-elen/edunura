...
import { getAllTeachers, Teacher } from '@/services/teachers';
        ...
        const fetchTeachers = async () => {
            ...
            try {
                const response = searchTerm
                    ? await getAllTeachers(searchTerm)
                    : await getAllTeachers(undefined, 'active');
                const availableTeachers = (response.data || []).filter((teacher: Teacher) =>
